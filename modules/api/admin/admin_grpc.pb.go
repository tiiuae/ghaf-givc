...
const (
	...
	AdminService_VMSize_FullMethodName            = "/admin.AdminService/VMSize"
)
...
type AdminServiceClient interface {
	...
	VMSize(ctx context.Context, in *vm.VMSizeRequest, opts ...grpc.CallOption) (*vm.VMSizeResponse, error)
}
...
func (c *adminServiceClient) VMSize(ctx context.Context, in *vm.VMSizeRequest, opts ...grpc.CallOption) (*vm.VMSizeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(vm.VMSizeResponse)
	err := c.cc.Invoke(ctx, AdminService_VMSize_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServiceServer interface {
	...
	// Set VM memory limits
	VMSize(context.Context, *vm.VMSizeRequest) (*vm.VMSizeResponse, error)
...
func (UnimplementedAdminServiceServer) VMSize(context.Context, *vm.VMSizeRequest) (*vm.VMSizeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VMSize not implemented")
}
...
func _AdminService_VMSize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(vm.VMSizeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).VMSize(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_VMSize_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).VMSize(ctx, req.(*vm.VMSizeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VMSize",
			Handler:    _AdminService_VMSize_Handler,
		},
	},
