...
import (
	...
	update "givc/modules/api/update"
...
const (
	...
	AdminService_StopService_FullMethodName       = "/admin.AdminService/StopService"
...
type AdminServiceClient interface {
	...
	StartService(ctx context.Context, in *ServiceRequest, opts ...grpc.CallOption) (*StartResponse, error)
	// Stop a remote service (unit) on a target VM
	StopService(ctx context.Context, in *ServiceRequest, opts ...grpc.CallOption) (*ApplicationResponse, error)
	...
	// OTA
	ListGenerations(ctx context.Context, in *update.Empty, opts ...grpc.CallOption) (*update.ListGenerationsResponse, error)
	SetGeneration(ctx context.Context, in *update.SetGenerationRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[update.SetGenerationResponse], error)
	Discover(ctx context.Context, in *update.RegistryDiscoverRequest, opts ...grpc.CallOption) (*update.RegistryDiscoverResponse, error)
	Changelog(ctx context.Context, in *update.RegistryChangelogRequest, opts ...grpc.CallOption) (*update.RegistryChangelogResponse, error)
	Pull(ctx context.Context, in *update.RegistryPullRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[update.RegistryPullResponse], error)
	ImageInstall(ctx context.Context, in *update.ImageInstallRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[update.ImageInstallResponse], error)
	// Send user notification
	NotifyUser(ctx context.Context, in *UserNotificationRequest, opts ...grpc.CallOption) (*notify.Status, error)
	// Perform CTAP action
	Ctap(ctx context.Context, in *ctap.CtapRequest, opts ...grpc.CallOption) (*ctap.CtapResponse, error)
	// Get host sysinfo values in one call
	Sysinfo(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*stats.SysinfoResponse, error)
}
...
func (c *adminServiceClient) StartService(ctx context.Context, in *ServiceRequest, opts ...grpc.CallOption) (*StartResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StartResponse)
...
func (c *adminServiceClient) StopService(ctx context.Context, in *ServiceRequest, opts ...grpc.CallOption) (*ApplicationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApplicationResponse)
	err := c.cc.Invoke(ctx, AdminService_StopService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) ListGenerations(ctx context.Context, in *update.Empty, opts ...grpc.CallOption) (*update.ListGenerationsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(update.ListGenerationsResponse)
...
func (c *adminServiceClient) SetGeneration(ctx context.Context, in *update.SetGenerationRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[update.SetGenerationResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AdminService_ServiceDesc.Streams[1], AdminService_SetGeneration_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[update.SetGenerationRequest, update.SetGenerationResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AdminService_SetGenerationClient = grpc.ServerStreamingClient[update.SetGenerationResponse]

func (c *adminServiceClient) Discover(ctx context.Context, in *update.RegistryDiscoverRequest, opts ...grpc.CallOption) (*update.RegistryDiscoverResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(update.RegistryDiscoverResponse)
...
func (c *adminServiceClient) Changelog(ctx context.Context, in *update.RegistryChangelogRequest, opts ...grpc.CallOption) (*update.RegistryChangelogResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(update.RegistryChangelogResponse)
...
func (c *adminServiceClient) Pull(ctx context.Context, in *update.RegistryPullRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[update.RegistryPullResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AdminService_ServiceDesc.Streams[2], AdminService_Pull_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[update.RegistryPullRequest, update.RegistryPullResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AdminService_PullClient = grpc.ServerStreamingClient[update.RegistryPullResponse]

func (c *adminServiceClient) ImageInstall(ctx context.Context, in *update.ImageInstallRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[update.ImageInstallResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AdminService_ServiceDesc.Streams[3], AdminService_ImageInstall_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[update.ImageInstallRequest, update.ImageInstallResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AdminService_ImageInstallClient = grpc.ServerStreamingClient[update.ImageInstallResponse]
...
func (c *adminServiceClient) Ctap(ctx context.Context, in *ctap.CtapRequest, opts ...grpc.CallOption) (*ctap.CtapResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ctap.CtapResponse)
	err := c.cc.Invoke(ctx, AdminService_Ctap_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) Sysinfo(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*stats.SysinfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(stats.SysinfoResponse)
	err := c.cc.Invoke(ctx, AdminService_Sysinfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServiceServer interface {
	...
	// Start a remote service
	StartService(context.Context, *ServiceRequest) (*StartResponse, error)
	// Stop a remote service (unit) on a target VM
	StopService(context.Context, *ServiceRequest) (*ApplicationResponse, error)
	// Pause (freeze) a remote application
	...
	// OTA
	ListGenerations(context.Context, *update.Empty) (*update.ListGenerationsResponse, error)
	SetGeneration(*update.SetGenerationRequest, grpc.ServerStreamingServer[update.SetGenerationResponse]) error
	Discover(context.Context, *update.RegistryDiscoverRequest) (*update.RegistryDiscoverResponse, error)
	Changelog(context.Context, *update.RegistryChangelogRequest) (*update.RegistryChangelogResponse, error)
	Pull(*update.RegistryPullRequest, grpc.ServerStreamingServer[update.RegistryPullResponse]) error
	ImageInstall(*update.ImageInstallRequest, grpc.ServerStreamingServer[update.ImageInstallResponse]) error
	// Send user notification
	NotifyUser(context.Context, *UserNotificationRequest) (*notify.Status, error)
	// Perform CTAP action
	Ctap(context.Context, *ctap.CtapRequest) (*ctap.CtapResponse, error)
	// Get host sysinfo values in one call
	Sysinfo(context.Context, *Empty) (*stats.SysinfoResponse, error)
...
func (UnimplementedAdminServiceServer) StartService(context.Context, *ServiceRequest) (*StartResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StartService not implemented")
}
func (UnimplementedAdminServiceServer) StopService(context.Context, *ServiceRequest) (*ApplicationResponse, error) {
...
func (UnimplementedAdminServiceServer) PauseApplication(context.Context, *ApplicationRequest) (*ApplicationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PauseApplication not implemented")
}
func (UnimplementedAdminServiceServer) ResumeApplication(context.Context, *ApplicationRequest) (*ApplicationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResumeApplication not implemented")
}
...
func (UnimplementedAdminServiceServer) GetUnitStatus(context.Context, *UnitStatusRequest) (*systemd.UnitStatus, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUnitStatus not implemented")
}
...
func (UnimplementedAdminServiceServer) QueryList(context.Context, *Empty) (*QueryListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method QueryList not implemented")
}
func (UnimplementedAdminServiceServer) Watch(*Empty, grpc.ServerStreamingServer[WatchItem]) error {
	return status.Error(codes.Unimplemented, "method Watch not implemented")
}
func (UnimplementedAdminServiceServer) ListGenerations(context.Context, *update.Empty) (*update.ListGenerationsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListGenerations not implemented")
}
func (UnimplementedAdminServiceServer) SetGeneration(*update.SetGenerationRequest, grpc.ServerStreamingServer[update.SetGenerationResponse]) error {
	return status.Error(codes.Unimplemented, "method SetGeneration not implemented")
}
func (UnimplementedAdminServiceServer) Discover(context.Context, *update.RegistryDiscoverRequest) (*update.RegistryDiscoverResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Discover not implemented")
}
func (UnimplementedAdminServiceServer) Changelog(context.Context, *update.RegistryChangelogRequest) (*update.RegistryChangelogResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Changelog not implemented")
}
func (UnimplementedAdminServiceServer) Pull(*update.RegistryPullRequest, grpc.ServerStreamingServer[update.RegistryPullResponse]) error {
	return status.Error(codes.Unimplemented, "method Pull not implemented")
}
func (UnimplementedAdminServiceServer) ImageInstall(*update.ImageInstallRequest, grpc.ServerStreamingServer[update.ImageInstallResponse]) error {
...
func (UnimplementedAdminServiceServer) Ctap(context.Context, *ctap.CtapRequest) (*ctap.CtapResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Ctap not implemented")
}
func (UnimplementedAdminServiceServer) Sysinfo(context.Context, *Empty) (*stats.SysinfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Sysinfo not implemented")
}
...
func _AdminService_StartService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).StartService(ctx, req.(*ServiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AdminService_StopService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_StopService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).StopService(ctx, req.(*ServiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AdminService_ListGenerations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).ListGenerations(ctx, req.(*update.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _AdminService_SetGeneration_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(update.SetGenerationRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AdminServiceServer).SetGeneration(m, &grpc.GenericServerStream[update.SetGenerationRequest, update.SetGenerationResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AdminService_SetGenerationServer = grpc.ServerStreamingServer[update.SetGenerationResponse]
...
func _AdminService_Discover_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(update.RegistryDiscoverRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).Discover(ctx, req.(*update.RegistryDiscoverRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AdminService_Changelog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(update.RegistryChangelogRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).Changelog(ctx, req.(*update.RegistryChangelogRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AdminService_Pull_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(update.RegistryPullRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AdminServiceServer).Pull(m, &grpc.GenericServerStream[update.RegistryPullRequest, update.RegistryPullResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AdminService_PullServer = grpc.ServerStreamingServer[update.RegistryPullResponse]

func _AdminService_ImageInstall_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(update.ImageInstallRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AdminServiceServer).ImageInstall(m, &grpc.GenericServerStream[update.ImageInstallRequest, update.ImageInstallResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AdminService_ImageInstallServer = grpc.ServerStreamingServer[update.ImageInstallResponse]
...
func _AdminService_Ctap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ctap.CtapRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).Ctap(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_Ctap_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).Ctap(ctx, req.(*ctap.CtapRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AdminService_Sysinfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).Sysinfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_Sysinfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).Sysinfo(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Ctap",
			Handler:    _AdminService_Ctap_Handler,
		},
		{
			MethodName: "Sysinfo",
			Handler:    _AdminService_Sysinfo_Handler,
		},
	},
