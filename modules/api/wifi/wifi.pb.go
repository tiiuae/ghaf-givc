...
const file_wifi_wifi_proto_rawDesc = "" +
	"\n" +
	"\x0fwifi/wifi.proto\x12\vwifimanager\"\x0e\n" +
	"\fEmptyRequest\"6\n" +
	"\x12WifiNetworkRequest\x12 \n" +
	"\vNetworkName\x18\x01 \x01(\tR\vNetworkName\"c\n" +
	"\x15WifiConnectionRequest\x12\x12\n" +
	"\x04SSID\x18\x01 \x01(\tR\x04SSID\x12\x1a\n" +
	"\bPassword\x18\x02 \x01(\tR\bPassword\x12\x1a\n" +
	"\bSettings\x18\x03 \x01(\tR\bSettings\"u\n" +
	"\vAccessPoint\x12\x1e\n" +
	"\n" +
	"Connection\x18\x01 \x01(\bR\n" +
	"Connection\x12\x12\n" +
	"\x04SSID\x18\x02 \x01(\tR\x04SSID\x12\x16\n" +
	"\x06Signal\x18\x03 \x01(\rR\x06Signal\x12\x1a\n" +
	"\bSecurity\x18\x04 \x01(\tR\bSecurity\"K\n" +
	"\x13WifiNetworkResponse\x124\n" +
	"\bnetworks\x18\x01 \x03(\v2\x18.wifimanager.AccessPointR\bnetworks\"4\n" +
	"\x16WifiConnectionResponse\x12\x1a\n" +
	"\bResponse\x18\x01 \x01(\tR\bResponse2\xfc\x03\n" +
	"\vWifiService\x12R\n" +
	"\vListNetwork\x12\x1f.wifimanager.WifiNetworkRequest\x1a .wifimanager.WifiNetworkResponse\"\x00\x12L\n" +
	"\x13GetActiveConnection\x12\x19.wifimanager.EmptyRequest\x1a\x18.wifimanager.AccessPoint\"\x00\x12[\n" +
	"\x0eConnectNetwork\x12\".wifimanager.WifiConnectionRequest\x1a#.wifimanager.WifiConnectionResponse\"\x00\x12U\n" +
	"\x11DisconnectNetwork\x12\x19.wifimanager.EmptyRequest\x1a#.wifimanager.WifiConnectionResponse\"\x00\x12J\n" +
	"\x06TurnOn\x12\x19.wifimanager.EmptyRequest\x1a#.wifimanager.WifiConnectionResponse\"\x00\x12K\n" +
	"\aTurnOff\x12\x19.wifimanager.EmptyRequest\x1a#.wifimanager.WifiConnectionResponse\"\x00B\x17Z\x15givc/modules/api/wifib\x06proto3"

var (
	file_wifi_wifi_proto_rawDescOnce sync.Once
	file_wifi_wifi_proto_rawDescData []byte
)

func file_wifi_wifi_proto_rawDescGZIP() []byte {
	file_wifi_wifi_proto_rawDescOnce.Do(func() {
		file_wifi_wifi_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wifi_wifi_proto_rawDesc), len(file_wifi_wifi_proto_rawDesc)))
	})
...
func file_wifi_wifi_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wifi_wifi_proto_rawDesc), len(file_wifi_wifi_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
