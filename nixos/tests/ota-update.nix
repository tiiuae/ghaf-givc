        ...
        module = rec {
          ...
          testScript =
            ...
            ''
              ...
              print(hostvm.succeed(f"ota-update --no-check-signs --set {update} --source ssh-ng://root@${(builtins.head nodes.adminvm.networking.interfaces.eth1.ipv4.addresses).address}", timeout=30))
